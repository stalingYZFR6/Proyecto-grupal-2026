...
const Login = () => {
    ...
    const iniciarSesion = async () => {
        try {
            ...
            if (data.user) {
                // Obtener el rol y datos del usuario desde la tabla public.usuarios
                ...
                localStorage.setItem("usuario-rol", userData.rol);
                localStorage.setItem("usuario-id-empleado", userData.id_empleado);
...
<dyad-write path="src/views/Login.jsx" description="Actualizar Login para guardar el rol del usuario en localStorage al iniciar sesión">
import { Container, Row, Col } from "react-bootstrap";
import React, { useState, useEffect } from "react";
import { useNavigate } from "react-router-dom";
import FormularioLogin from "../components/login/FormularioLogin";
